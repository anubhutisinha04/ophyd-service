...
from queueserver_service.manager.profile_ops import load_profile_collection
from queueserver_service.manager.profile_tools import (
    clear_ipython_mode,
...
def create_local_imports_files(tmp_path):
    ...
    # Create file1
    code1 = """
from queueserver_service.manager.profile_tools import set_user_ns
...
from queueserver_service.manager.profile_tools import is_re_worker_active
