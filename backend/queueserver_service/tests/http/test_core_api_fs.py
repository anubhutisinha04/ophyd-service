...
from tests.manager.plan_lists import create_excel_file_from_plan_list, plan_list_sample
...
@pytest.mark.parametrize("custom_module_list", [
    ...
    "tests.manager.spreadsheet_custom_functions",
    "tests.manager.spreadsheet_custom_functions:bluesky_queueserver_api",
    "bluesky_queueserver_api:tests.manager.spreadsheet_custom_functions",
    "tests.manager.spreadsheet_custom_functions:non.existing.package",
    "non.existing.package:tests.manager.spreadsheet_custom_functions",
